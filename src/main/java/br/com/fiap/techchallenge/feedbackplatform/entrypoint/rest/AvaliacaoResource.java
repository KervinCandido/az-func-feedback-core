...
@Tag(name = "Avaliações", description = "Endpoint para envio de feedbacks de aulas e cursos online.")
public class AvaliacaoResource {
    ...
    @Operation(
            ...
            description = "Recebe uma avaliação de estudante, classifica a urgência, persiste o feedback e registra o evento na outbox."
    )
    @APIResponse(
            responseCode = "201",
            description = "Avaliação criada com sucesso.",
            content = @Content(schema = @Schema(implementation = CreateAvaliacaoResponse.class))
    )
    @APIResponse(
            responseCode = "400",
